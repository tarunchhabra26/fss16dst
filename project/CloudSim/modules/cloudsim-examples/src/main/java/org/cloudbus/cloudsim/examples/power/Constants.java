...
public class Constants {
	...
	public static int NUMBER_OF_CLOUDLETS = 2000;
	 ...
	 */
	public static int HOST_TYPES	 = 4;
	public static int[] HOST_MIPS	 = { 1860, 2660, 3000, 4000 };
	public static int[] HOST_PES	 = { 2, 2, 4, 4 };
	public static int[] HOST_RAM	 = { 4096, 4096, 8192,8192 };
