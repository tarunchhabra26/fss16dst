...
public class CloudSimPowerProblemIntDouble extends AbstractDoubleProblem implements ConstrainedProblem<DoubleSolution> {
	...
	public CloudSimPowerProblemIntDouble() {
