...
public class ContainerCloudSimExample1 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("One run took : " + interval + " ms");
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static List<ContainerCloudlet> createContainerCloudletList(int brokerId, int numberOfCloudlets)
			throws FileNotFoundException {
		String inputFolderName = ContainerCloudSimExample1.class.getClassLoader().getResource("workload/planetlab")
				.getPath();
		inputFolderName = "/Users/tarunchhabra/Documents/Courses/Fall 2016/CSC 591/Project-CloudSim/cloudsim-cloudsim-4.0/modules/cloudsim-examples/target/classes/workload/planetlab";
		ArrayList<ContainerCloudlet> cloudletList = new ArrayList<ContainerCloudlet>();
		long fileSize = 300L;
		long outputSize = 300L;
		UtilizationModelNull utilizationModelNull = new UtilizationModelNull();
		java.io.File inputFolder1 = new java.io.File(inputFolderName);
		if (inputFolder1.isDirectory())
			System.out.println("Input folder : " + inputFolderName + " is a directory");
